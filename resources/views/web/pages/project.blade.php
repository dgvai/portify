...
@section('content')
    ...
    <div id="blog" class="container-fluid">
        <div class="blog-head" style="background: rgba(0,0,0,0.75) url('{{$project->image_url}}') center center no-repeat; background-size: cover; background-blend-mode: darken"></div>
